...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container-fluid px-sm-5" data-aos="fade-right">
    <a class="navbar-brand web-logo" href="{{url('/home')}}"> <img src="{{asset('public/assets/images/logo.svg')}}" alt="image"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto nav-list ">
        <li class="nav-item mr-lg-4">
          <a class="nav-link px-2 trainer-link" href="{{url('/trainer/login')}}"> <span>BEC</span>OME A TRAINER</a>
        </li>
        <li class="nav-item mr-lg-4 ">
