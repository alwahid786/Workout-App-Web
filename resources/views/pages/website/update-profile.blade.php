...
<form action="{{route('updateProfile')}}" method="post" enctype="multipart/form-data" id="updateProfileForm">
    ...
    <div class="container pt-5">
        <div class="row">
            ...
            <div class="col-md-6" >
                <div class="form-group pro-form select-country">
                    <label for="inputAddress2" class=" ">Country</label>
                    <select class="selectpicker " data-class="no-validation" data-live-search="true" onchange="print_state('state',this.selectedIndex,'step2')" id="country" name="country"></select>
                </div>
            </div>
            <div class="col-md-6" >
                <div class="form-group pro-form select-country">
