                    ...
                    <div class="experienced-trainer-card my-5">
                        ...
                        <div class="experienced-trainer-card-right pl-2">
                            ...
                            <div class="trainer-card-rating">
                                <h1>{{$data['trainer']['country']}}<span>{{$data['trainer']['state']}}</span></h1>
