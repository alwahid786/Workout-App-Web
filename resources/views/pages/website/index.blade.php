...
<style>
    ...
    .loaderDiv {
        ...
        bottom: 0;
        width: 100%;
        background: rgba(0, 0, 0, 0.75) url("../../../../public/assets/images/loader.svg") no-repeat center center;
        z-index: 99999;
    }
    ...
    <div class="container hero-section-wrapper" data-aos="fade-left">
        <div class="row">
            ...
            <div class="col-md-6 order-1 order-md-2 hero-right text-center mb-5 mb-md-0">
                <img src="{{asset('public/assets/images/cs_aboutUs_2.jpg')}}" alt="image">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6 mt-3">
                <div class="rating-right py-3" data-aos="zoom-in">
                    <img class="mb-3" style="object-position: 0% 66%" src="{{asset('public/assets/images/cs_aboutUs_4.jpg')}}" alt="image">
